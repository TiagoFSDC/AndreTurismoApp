...
namespace AndreTurismoApp.ClientService.Controllers
{
    ...
    public class ClientsController : ControllerBase
    {
        ...
        public async Task<ActionResult<Client>> PostClient(Client client)
        {
            ...
            AddressDTO addreesDto = PostOfficeServices.GetAddress(client.address.ZipCode).Result;
            Address addressComplete = new Address(addreesDto);
            addressComplete.Number = client.address.Number;

            client.address = addressComplete;
